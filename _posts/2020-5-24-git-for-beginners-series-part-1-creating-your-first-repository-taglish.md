...
layout: post
published: false
title: "Git for Beginners Series - (Part 1) Creating your first repository (Tagalog/English)"
---

> Narinig mo na ba ang tool na Git?
> Malamang narinig mo na siguro!
> Ngunit bakit ka nandito?
> Siguro ikaw isang baguhan lamang na programmer?
> O isang estudyante sa kolehiyo at nais na magsimula ng isang karera sa tech?
> Anuman ang iyong layunin, ang tutorial na ito ay naglalayong tulungan kang magsimula sa Git kung hindi mo pa ito nasusubukan.

### Kaunting kaalaman tungkol sa Git...

Ang <a href="https://git-scm.com" target="_blank">Git</a> ay isang <a href="https://git-scm.com/about/free-and-open-source" target="_blank">free and open source</a> distributed version control system.

<br />

### Pero ano nga ba ang Distributed Version Control System?

Kung nakapaglaro ka na ng mga video games dati, madalas ay makikita mo ang tinatawag na "<a href="https://en.wikipedia.org/wiki/Saved_game" target="_blank">Save Game</a>". Binibigyan nito ang player (ikaw) ng kakayahan na i-save ang iyong pag-unlad upang maaari kang bumalik sa ibang pagkakataon at i-play ang laro kung saan mo ito iniwan.
